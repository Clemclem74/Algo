...
protocol PieceProtocol:{
    ...
    //On transforme le kodama en kodama samura・
    //Pre: La piece doit 黎re un kodama et doit etre au fond du plateau et ne pas avoir ete parachutee directement au fond
    //Post: On transforme le kodama en kodama samoura・ Si les preconditions ne sont pas remplies on ne fait rien.
    @discardableResult
    ...
    //Pre: La piece doit 黎re un kodama et doit etre au fond du plateau et ne pas avoir ete parachutee directement au fond
    //Post: On transforme le kodama samoura・en kodama. Si les preconditions ne sont pas remplies on ne fait rien.
    @discardableResult
